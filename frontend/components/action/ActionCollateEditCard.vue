  ...
  <div>
    ...
    <div>
      <div class="mx-auto py-1 flex items-center">
        ...
        <button @click.prevent="addModifier" class="flex items-center mx-2">
          <StopCircleIcon 
            class="text-ochre-600 hover:bg-ochre-100 rounded-full h-5 w-5" 
            aria-hidden="true" />
        </button>
        <div aria-hidden="true" class="h-5 w-px bg-gray-300" />
