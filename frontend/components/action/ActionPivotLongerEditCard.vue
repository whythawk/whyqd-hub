...
const selectedDestinationNameField = ref("Select ...")
const selectedDestinationValueField = ref("Select ...")
...
function submitRequest() {
  if (
    (selectedDestinationNameField.value !== "Select ..."
      && selectedDestinationValueField.value !== "Select ..."
