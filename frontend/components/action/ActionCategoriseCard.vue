<template>
  <div class="flex items-center">
    ...
    <span class="text-cerulean-600">{{ props.action.destinationTerm }}</span>
    <img src="/img/bracket-source.svg" class="h-5 mx-1" />
    <span class="text-eucalyptus-600">
      <!-- @vue-ignore -->
      <CommonExpanderSlot :term="props.action.sourceTerm.join(', ')" class="w-40" />
    </span>
    <img src="/img/bracket-divider.svg" class="h-5 mx-1" />
    <span class="text-eucalyptus-600 font-semibold">{{ props.action.sourceField }}</span>
