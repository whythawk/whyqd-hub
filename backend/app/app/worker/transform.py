...
def process_schema_categorisation(user_id: str, resource_id: dict, field_name: str, term_type: str) -> str:
...
def process_transform(user_id: str, resource_id: dict, mimetype: Union[str, None] = None) -> str:
